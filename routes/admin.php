...
Route::middleware(['auth', 'admin', 'activity-log'])->group(function () {
    ...
    // Portfolio content (projects, experience, skills, testimonials, education,
    // certifications) has no admin screens of its own: it is all key/value lists
    // declared by the active theme's settings.blade.php and edited on the single
    // Theme Settings screen above, so there is nothing to route here.
