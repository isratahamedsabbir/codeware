...
<header x-data="{ open: false }" x-on:keydown.escape.window="open = false"
    class="pf-header fixed inset-x-0 top-0 z-20 border-b border-(--pf-border) bg-(--pf-bg)/70 backdrop-blur-xl">
    {{-- Reading progress. Driven by script.js off the page's scroll depth; a
    ...
    <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center gap-2.5">
            ...
            <button type="button" data-pf-theme-toggle aria-label="Toggle light / dark theme" class="pf-icon-button">
