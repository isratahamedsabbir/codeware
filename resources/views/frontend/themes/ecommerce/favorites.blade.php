...
<main>
    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6">
        <div class="mb-6">
            <h1 class="text-center text-lg font-bold uppercase tracking-wide text-zinc-800 md:text-2xl">{{ __('My favorites') }}</h1>
            <p class="mt-1 text-center text-sm text-gray-600">{{ __('Products you saved, ready when you are.') }}</p>
        </div>

        @if ($products->isEmpty())
            <div class="rounded-md border border-dashed border-zinc-300 bg-white px-6 py-16 text-center">
                ...
                <h2 class="mt-4 text-lg font-semibold text-zinc-800">{{ __('No favorites yet') }}</h2>
