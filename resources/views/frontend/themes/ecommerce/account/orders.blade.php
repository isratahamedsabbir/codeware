...
<main>
    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6">
        <div class="mb-6">
            <h1 class="text-lg font-bold uppercase tracking-wide text-sf-text md:text-2xl">{{ __('My Orders') }}</h1>
            ...
            <div class="min-w-0 flex-1">
                @if ($orders->isEmpty())
                    <div class="rounded-card border border-dashed border-zinc-300 bg-white px-6 py-16 text-center">
                        ...
                        <h2 class="mt-4 text-lg font-semibold text-sf-text">{{ __('No orders yet') }}</h2>
                ...
                @else
                    <div class="overflow-x-auto rounded-card border border-zinc-200 bg-white">
                            ...
                            <tbody class="divide-y divide-zinc-100">
                                @foreach ($orders as $order)
                                    <tr class="hover:bg-gray-50/60">
                                        <td class="px-5 py-3.5 font-semibold text-sf-text">{{ $order->order_number }}</td>
