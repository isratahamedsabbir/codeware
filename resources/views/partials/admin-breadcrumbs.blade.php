@php
    ...
    $sectionMap = [
        ...
        'portfolio-projects' => ['Portfolio', 'admin.portfolio-projects'],
        'portfolio-experiences' => ['Portfolio', 'admin.portfolio-projects'],
        'portfolio-skills'   => ['Portfolio', 'admin.portfolio-projects'],
