<x-admin-section-card icon="magnifying-glass" title="Search Engine (SEO) Settings"
    ...
    {{-- One switch for the whole section. The meta, Open Graph and Twitter copy
         are all read in the same language as the page they belong to, so a single
    ...
    <x-admin-locale-tabs>
        ...
        <div class="space-y-5">
            ...
            {{-- These are the fields a search engine reads, and they are read
                 ...
                 is a wasted impression. The strip above picks which language
                 these fields are writing. --}}
