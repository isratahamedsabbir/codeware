...
<div class="email-wrapper" style="background:#eef5fb;padding:32px 16px;min-height:100vh;">
  <div style="max-width:580px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0;">

    <!-- â”€â”€ HERO STRIP â”€â”€ -->
    <div class="hero-strip" style="background:#1e7bc4;padding:28px 40px;display:flex;align-items:center;gap:16px;">
    ...
    <div class="body-pad" style="padding:36px 40px;">
      ...
      <div class="contact-row" style="display:flex;gap:12px;">
        ...
        <a href="mailto:{{ \App\Models\Setting::get('contact_email') }}"
          ...
          <div>
            ...
            <p style="margin:3px 0 0;font-size:12px;color:#0b5f9e;font-weight:600;">{{ \App\Models\Setting::get('contact_email') }}</p>
          </div>
        </a>
        @endif
        ...
        <a href="{{ config('app.frontend_url') }}"
          ...
          <div>
            ...
            <p style="margin:3px 0 0;font-size:12px;color:#0b5f9e;font-weight:600;">{{ config('app.name') }}</p>
          </div>
        </a>
        @endif
      ...
      <div style="text-align:center;margin-top:32px;">
        <a href="{{ config('app.frontend_url') }}"
           style="display:inline-block;background:#1e7bc4;color:#ffffff;font-family:'Poppins',Arial,sans-serif;font-size:14px;font-weight:600;padding:14px 40px;border-radius:50px;letter-spacing:0.4px;">
          Visit Our Website
        </a>
      </div>
      @endif
