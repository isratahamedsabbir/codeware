...
<head>
    ...
    <title>Your delivery code</title>
</head>
    ...
    <div style="padding:32px 16px;">
        <div style="max-width:480px;margin:0 auto;background:#fff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
            <div style="padding:28px 36px;background:#1e7bc4;color:#fff;">
                <h1 style="margin:0;font-size:22px;">{{ __('Your order is at your door') }}</h1>
                <p style="margin:8px 0 0;font-size:14px;">{{ __('Hi :name, give this code to the delivery person to receive order :order.', ['name' => $name, 'order' => $orderNumber]) }}</p>
            </div>
            <div style="padding:32px 36px;text-align:center;">
                ...
                <p style="margin:20px 0 0;font-size:13px;color:#64748b;">{{ __('This code expires in 10 minutes. Only share it once you have your order in hand.') }}</p>
            </div>
