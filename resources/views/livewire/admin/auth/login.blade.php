<div>
    <div class="flex flex-col gap-5 w-full">
        {{-- Which login this is — same visual design as the vendor login, so
        ...
        <form wire:submit="authenticate" class="flex flex-col gap-5">
            ...
            {{-- Submit --}}
            <div class="pt-1">
                <button type="submit" data-test="admin-login-button"
    ...
    {{-- reCAPTCHA ready-token intercept: Livewire doesn't know about the
