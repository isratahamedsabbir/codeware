<div class="bg-white rounded-lg border border-zinc-100 shadow-sm overflow-hidden">
    ...
    <div class="flex items-center justify-between gap-3 px-6 py-5 border-b border-zinc-100 flex-wrap">
        <div>
            <h1 class="text-lg font-semibold text-zinc-900">Products</h1>
            <p class="text-sm text-zinc-600 mt-0.5">Manage agricultural products. Drag to reorder.</p>
        </div>
            ...
            <table class="w-full border-collapse" style="table-layout:fixed">
                ...
                <tbody x-ref="sortableRows">
                    @forelse ($products as $product)
                        <tr class="border-b border-zinc-50 hover:bg-indigo-50/30 transition-colors" data-product-id="{{ $product->id }}">
