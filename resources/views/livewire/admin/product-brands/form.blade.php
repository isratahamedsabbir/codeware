<div class="max-w-[1600px] w-full mx-auto flex-1">
    ...
    <div class="w-full max-w-2xl bg-white rounded-[5px] shadow-sm p-6 space-y-4">
        ...
        <flux:field>
            <flux:label>Type<x-field-hint text="Post brands show on the Post form, product brands on the Product form" /></flux:label>
        ...
        <flux:field>
            <flux:label>Type<x-field-hint text="Product brands appear in the Product form's brand dropdown; post brands are tracked for parity with tags" /></flux:label>
            <flux:select wire:model="type">
                <flux:select.option value="product_brand">Product</flux:select.option>
                <flux:select.option value="post_brand">Post</flux:select.option>
            </flux:select>
            <flux:error name="type" />
        </flux:field>
