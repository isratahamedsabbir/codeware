<div class="bg-white rounded-lg border border-zinc-100 shadow-sm overflow-hidden">
    ...
    <div class="flex items-center justify-between gap-3 px-6 py-5 border-b border-zinc-100 flex-wrap">
        <div>
            <h1 class="text-lg font-semibold text-zinc-900">Tags</h1>
            <p class="text-sm text-zinc-600 mt-0.5">Label posts with relevant tags</p>
        </div>
    ...
    <flux:modal name="tag-delete" class="md:w-80"
        ...
        <div class="space-y-4">
            ...
            <flux:text class="text-sm text-zinc-500">This action cannot be undone. The tag will be soft-deleted.
            </flux:text>
