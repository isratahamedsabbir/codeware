<div class="bg-white rounded-lg border border-zinc-100 shadow-sm overflow-hidden">
    ...
    <div class="flex items-center justify-between gap-3 px-6 py-5 border-b border-zinc-100 flex-wrap">
        <div>
            <h1 class="text-lg font-semibold text-zinc-900">Districts</h1>
            <p class="text-sm text-zinc-600 mt-0.5">Manage Bangladesh districts</p>
        </div>
        <a href="{{ route('admin.districts.create') }}" wire:navigate
                        ...
                        <tr class="border-b border-zinc-50 hover:bg-indigo-50/30 transition-colors">
                            ...
                            <td class="px-4 py-3.5">
                                <div class="font-medium text-zinc-900 text-sm leading-snug">
                                    {{ $district->getTranslation('name', 'en', false) }}
                                </div>
                                @if ($district->getTranslation('name', 'bn', false))
                                    <div class="text-xs text-zinc-600 mt-0.5">
                                        {{ $district->getTranslation('name', 'bn', false) }}
                                    </div>
                                @endif
                            </td>
                            ...
                            <td class="px-4 py-3.5">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <div class="relative group">
                                        <a href="{{ route('admin.districts.edit', $district->id) }}" wire:navigate
    ...
    <flux:modal name="district-delete" class="md:w-80"
        ...
        <div class="space-y-4">
            ...
            <flux:text class="text-sm text-zinc-500">This action cannot be undone. The district will be soft-deleted.
            </flux:text>
