                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($districts as $district)
                        <tr wire:key="district-{{ $district->id }}"
                            class="group/row hover:bg-indigo-50/30 transition-colors cursor-default {{ in_array($district->id, $selectedIds, true) ? 'bg-indigo-50 ring-1 ring-inset ring-indigo-300' : '' }}"
