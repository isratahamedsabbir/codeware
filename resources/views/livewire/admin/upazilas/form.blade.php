<div class="max-w-[1600px] w-full mx-auto flex-1">
    ...
    <flux:button variant="ghost" icon="arrow-left" href="{{ route('admin.upazilas') }}" wire:navigate class="mb-4 border-2">
        Back
    </flux:button>
    ...
    <div class="flex gap-5 items-start">
        ...
        <div class="flex-1 min-w-0 bg-white rounded-lg border border-zinc-100 shadow-sm p-6">
            ...
            <h1 class="text-lg font-semibold text-zinc-900 mb-5 pb-4 border-b border-zinc-100">
                {{ $upazilaId ? 'Edit Upazila' : 'New Upazila' }}
            </h1>
            ...
            <div x-data="{ locale: 'en' }">
                ...
                <div class="mb-4">
                    <flux:field>
                        ...
                        <flux:select wire:model="district_id">
                ...
                <div x-show="locale==='en'" class="space-y-4">
                    <flux:field>
                        ...
                        <flux:input wire:model="name_en" placeholder="Upazila name in English" />
                ...
                <div x-show="locale==='bn'" class="space-y-4">
                    <flux:field>
                        ...
                        <flux:input wire:model="name_bn" placeholder="বাংলায় উপজেলার নাম" />
                    </flux:field>
                </div>
        ...
        <div class="w-[320px] shrink-0 space-y-4">
            ...
            <div class="flex justify-end items-center gap-3 border-t border-zinc-100 flex-wrap">
                <a href="{{ route('admin.upazilas') }}" wire:navigate
                ...
                <button wire:click="save" wire:loading.attr="disabled"
                    ...
                    {{ $upazilaId ? 'Update Upazila' : 'Create Upazila' }}
                </button>
            </div>
