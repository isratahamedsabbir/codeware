<div class="max-w-[1600px] w-full mx-auto flex-1">
    ...
    <div class="w-full bg-white rounded-[5px] shadow-sm p-6 space-y-3">
        ...
        <flux:field>
            <flux:label>Applies To<x-field-hint text="Leave empty for this coupon to apply to any order. Add one or more products to restrict it to just those." /></flux:label>
                ...
                x-data="{
                    ...
                    init() {
                        const handler = (e) => {
                            ...
                            if (e.target.closest('[data-coupon-product-panel]')) return;
                            this.open = false;
                        };
            ...
            >
                ...
                <template x-teleport="body">
                    <div data-coupon-product-panel x-show="open && filtered.length" x-cloak x-transition :style="panelStyle"
