<div class="bg-white rounded-lg border border-zinc-100 shadow-sm overflow-hidden">
    ...
    <div class="flex items-center justify-between gap-3 px-6 py-5 border-b border-zinc-100 flex-wrap">
        <div>
            <h1 class="text-lg font-semibold text-zinc-900">Blog Categories</h1>
            <p class="text-sm text-zinc-600 mt-0.5">Organise posts by category. Drag to reorder.</p>
        </div>
        <a href="{{ route('admin.blog-categories.create') }}" wire:navigate
                            ...
                            <td class="px-4 py-3.5">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <div class="relative group">
                                        <a href="{{ route('admin.blog-categories.edit', $category->id) }}" wire:navigate
