<div class="max-w-[1600px] w-full mx-auto flex-1">
    ...
    <flux:button variant="ghost" icon="arrow-left" href="{{ route('admin.departments') }}" wire:navigate
        class="mb-4 border-2">
        Back
    </flux:button>
            ...
            <div x-data="{ locale: 'en' }">
                ...
                <div x-show="locale==='en'" class="space-y-4">
                    <flux:field>
                        ...
                        <flux:input wire:model="name_en" placeholder="Department name in English" />
