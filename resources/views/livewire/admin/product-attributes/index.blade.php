                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($productAttributes as $attribute)
                        <tr wire:key="attribute-{{ $attribute->id }}"
                            class="group/row hover:bg-indigo-50/30 transition-colors cursor-default {{ in_array($attribute->id, $selectedIds, true) ? 'bg-indigo-50 ring-1 ring-inset ring-indigo-300' : '' }}"
