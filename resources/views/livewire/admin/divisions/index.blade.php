                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($divisions as $division)
                        <tr wire:key="division-{{ $division->id }}"
                            class="group/row hover:bg-indigo-50/30 transition-colors cursor-default {{ in_array($division->id, $selectedIds, true) ? 'bg-indigo-50 ring-1 ring-inset ring-indigo-300' : '' }}"
