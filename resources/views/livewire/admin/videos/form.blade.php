<div class="max-w-[1600px] w-full mx-auto flex-1">
    ...
    <flux:button variant="ghost" icon="arrow-left" href="{{ route('admin.videos') }}" wire:navigate class="mb-4 border-2">
        Back
    </flux:button>
            ...
            <div x-data="{ locale: 'en' }">
                ...
                <div x-show="locale==='en'" class="space-y-4">
                    <flux:field>
                        ...
                        <flux:input wire:model="title_en" placeholder="Video title in English" />
                ...
                <div x-show="locale==='bn'" class="space-y-4">
                    <flux:field>
                        ...
                        <flux:input wire:model="title_bn" placeholder="ভিডিওর শিরোনাম বাংলায়" />
                    </flux:field>
                </div>
                ...
                <div class="mt-5 pt-4 border-t border-zinc-100">
                    <flux:field>
                        <flux:label>YouTube Link <span class="text-red-500 ml-0.5">*</span></flux:label>
                        <flux:input wire:model="youtube_link" placeholder="https://www.youtube.com/watch?v=..." />
                        <flux:error name="youtube_link" />
                    </flux:field>
                </div>
        ...
        <div class="w-[320px] shrink-0 space-y-4">
            ...
            <div class="bg-white rounded-lg border border-zinc-100 shadow-sm overflow-hidden">
                ...
                <div class="px-4 py-4 border-b border-zinc-50">
                    <x-media-picker model="thumbnail" label="" placeholder="Select thumbnail from library"
                        :picker-id="$thumbnailPickerId" />
                </div>
