@push('page-header-actions')
    ...
    <flux:button variant="ghost" size="sm" icon="arrow-up-tray"
        onclick="window.dispatchEvent(new CustomEvent('open-media-picker', { detail: { pickerId: 'media-library-manage-picker', onlyImages: false, mimes: 'jpg,jpeg,png,gif,webp,avif,pdf,mp4,mp3,doc,docx,xls,xlsx', maxSizeKb: 10240 } }))">
        Upload Files
    </flux:button>
@endpush
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500">
                                ...
                                {{ $selectedMedia->created_at->toDisplay() }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-5 p-6 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2 grid grid-cols-2 gap-4 border-t border-slate-100 pt-4">
                            ...
                            <div>
                                <p class="text-[10px] font-medium uppercase tracking-widest text-slate-500 mb-1">
                                    Uploaded</p>
                                <p class="text-sm text-slate-800">{{ $mediaItem->created_at->toDisplay() }}</p>
                            </div>
                            <div>
            ...
            <div class="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-xl"
                ...
                <div class="grid gap-5 p-6">
                    ...
                    <x-media-picker model="watermarkImage" label="Watermark Image" hint="PNG with transparency works best"
                        placeholder="Select watermark image from library" mimes="png,jpg,jpeg,webp,avif" only-images dropzone />
