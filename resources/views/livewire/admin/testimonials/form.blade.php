<div class="max-w-[1600px] w-full mx-auto flex-1">
    ...
    <flux:button variant="ghost" icon="arrow-left" href="{{ route('admin.testimonials') }}" wire:navigate
        class="mb-4 border-2">
        Back
    </flux:button>
    ...
    <div class="flex gap-5 items-start">
        ...
        <div class="flex-1 min-w-0 bg-white rounded-lg border border-zinc-100 shadow-sm p-6">
            ...
            <div x-data="{ locale: 'en' }">
                ...
                <div x-show="locale==='en'" class="space-y-4">
                    <flux:field>
                        ...
                        <flux:input wire:model="name_en" placeholder="Testimonial name in English" />
                        <flux:error name="name_en" />
                    </flux:field>
                    <flux:field>
                        <flux:label>Comment <span class="text-red-500 ml-0.5">*</span></flux:label>
                        <flux:textarea wire:model="comment_en" rows="4"
                            placeholder="Testimonial comment in English" />
                        <flux:error name="comment_en" />
                    </flux:field>
                </div>
                ...
                <div x-show="locale==='bn'" class="space-y-4">
                    <flux:field>
                        ...
                        <flux:input wire:model="name_bn" placeholder="বাংলায় নাম" />
                    </flux:field>
                    <flux:field>
                        <flux:label>মন্তব্য</flux:label>
                        <flux:textarea wire:model="comment_bn" rows="4" placeholder="বাংলায় মন্তব্য" />
                    </flux:field>
                </div>
            ...
            <div class="mt-6 space-y-4">
                <flux:field>
                    ...
                    <flux:input wire:model="location" placeholder="Dhaka, Bangladesh" />
                </flux:field>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <flux:field>
                        ...
                        <flux:select wire:model="type">
                            ...
                            <flux:select.option value="dealer">Dealer</flux:select.option>
                        </flux:select>
                    </flux:field>
                    <flux:field>
        ...
        <div class="w-[320px] shrink-0 space-y-4">
            ...
            <div class="bg-white rounded-lg border border-zinc-100 shadow-sm overflow-hidden">
                ...
                <div class="px-4 py-4">
                    <x-media-picker model="image" label="" placeholder="Select image from library"
                        :picker-id="$imagePickerId" />
                </div>
            </div>
