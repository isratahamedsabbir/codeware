...
return [
    ...
    */
    ...
    'payload' => [
        'max_size' => 16 * 1024 * 1024, // 16MB - maximum request payload size in bytes (raised from the 1MB default so the admin File Manager can round-trip larger log/text files for editing)
