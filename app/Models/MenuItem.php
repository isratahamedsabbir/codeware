...
class MenuItem extends Model
{
    ...
    private const FEATURE_ROUTE_PREFIXES = [
        ...
        'admin.pages' => 'pages',
        'admin.cms' => 'cms',
        'admin.portfolio-projects' => 'portfolio',
        'admin.portfolio-experiences' => 'portfolio',
        'admin.portfolio-skills' => 'portfolio',
    ...
    public function isVisibleToCurrentUser(): bool
    {
        ...
        // Feature toggles (Settings → Features) are a developer + Super Admin-only
        // tool for turning whole modules on/off per deployment — the route itself
