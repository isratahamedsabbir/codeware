...
class ProductCategoryExportController extends Controller
{
     ...
     * in the bulk-selection toolbar on the Product Categories screen (see
     * Livewire\Admin\ProductCategories\Index::$selectedIds), so this always
    ...
    public function export(Request $request): StreamedResponse
    {
        ...
        $filename = 'product-categories-'.now()->format('Y-m-d-His').'.csv';
